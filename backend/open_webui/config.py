...
USER_PERMISSIONS_WORKSPACE_AGENTS_ACCESS = (
    os.getenv('USER_PERMISSIONS_WORKSPACE_AGENTS_ACCESS', 'False').lower() == 'true'
)
...
USER_PERMISSIONS_WORKSPACE_AGENTS_ALLOW_SHARING = (
    os.getenv('USER_PERMISSIONS_WORKSPACE_AGENTS_ALLOW_SHARING', 'False').lower() == 'true'
)

USER_PERMISSIONS_WORKSPACE_AGENTS_ALLOW_PUBLIC_SHARING = (
    os.getenv('USER_PERMISSIONS_WORKSPACE_AGENTS_ALLOW_PUBLIC_SHARING', 'False').lower() == 'true'
)
...
DEFAULT_USER_PERMISSIONS = {
    'workspace': {
        ...
        'agents': USER_PERMISSIONS_WORKSPACE_AGENTS_ACCESS,
    ...
    'sharing': {
        ...
        'agents': USER_PERMISSIONS_WORKSPACE_AGENTS_ALLOW_SHARING,
